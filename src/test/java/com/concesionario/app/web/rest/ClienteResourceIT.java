...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().dni(DEFAULT_DNI).nombre(DEFAULT_NOMBRE);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().dni(UPDATED_DNI).nombre(UPDATED_NOMBRE);
        return cliente;
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.dni(UPDATED_DNI).nombre(UPDATED_NOMBRE);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.dni(UPDATED_DNI).nombre(UPDATED_NOMBRE);
