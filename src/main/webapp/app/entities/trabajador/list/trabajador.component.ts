...
export class TrabajadorComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.trabajadorService
      ...
      .subscribe({
        next: (res: HttpResponse<ITrabajador[]>) => {
  ...
  trackId(index: number, item: ITrabajador): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITrabajador[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
