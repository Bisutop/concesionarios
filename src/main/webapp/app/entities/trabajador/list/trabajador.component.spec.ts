...
describe('Trabajador Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'trabajador', component: TrabajadorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trabajadors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
