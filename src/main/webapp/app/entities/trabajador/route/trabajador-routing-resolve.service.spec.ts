...
describe('Trabajador routing resolve service', () => {
  ...
  let routingResolveService: TrabajadorRoutingResolveService;
  let service: TrabajadorService;
  let resultTrabajador: ITrabajador | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(TrabajadorRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new ITrabajador if id is not provided', () => {
      // GIVEN
      ...
      expect(resultTrabajador).toEqual(new Trabajador());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Trabajador })));
      mockActivatedRouteSnapshot.params = { id: 123 };
